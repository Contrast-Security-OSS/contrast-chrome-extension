...
var _handleRuntimeOnMessage = function () {
	var _ref = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee(request, sendResponse, tab) {
		var tabPath, vulnerableTab, storedTabs, wappalyzedLibraries;
		return _regenerator2.default.wrap(function _callee$(_context) {
			while (1) {
				switch (_context.prev = _context.next) {
					case 0:
						_context.t0 = request.action;
						_context.next = _context.t0 === _util.TRACES_REQUEST ? 3 : _context.t0 === _util.APPLICATION_CONNECTED ? 11 : _context.t0 === _util.APPLICATION_DISCONNECTED ? 13 : _context.t0 === _util.LOADING_DONE ? 15 : _context.t0 === _util.CONTRAST_WAPPALIZE ? 17 : 22;
						break;
					...
					case 17:
						_context.next = 19;
						return (0, _wappalyzer.wappalzye)(tab);

					case 19:
						wappalyzedLibraries = _context.sent;
...
var _wappalyzer = require('./libraries/wappalyzer.js');
