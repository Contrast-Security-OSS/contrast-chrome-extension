      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = _context.t0 === _util.TRACES_REQUEST ? 5 : _context.t0 === _util.APPLICATION_CONNECTED ? 17 : _context.t0 === _util.APPLICATION_DISCONNECTED ? 20 : _context.t0 === _util.LOADING_DONE ? 23 : 26;
            break;
          ...
          case 5:
            ...
            console.log("TAB PATH", tabPath, request.application.name);
            vulnerableTab = new _VulnerableTab2.default(tabPath, request.application.name);

            console.log("VULN TAB", vulnerableTab);
            _context.next = 12;
          ...
          case 28:
            console.log("RETURNING FALSEY REQUEST", request);
            return _context.abrupt("return", request);
