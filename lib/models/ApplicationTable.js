...
ApplicationTable.prototype.renderApplicationsMenu = function () {
  ...
  var tableElements = [document.getElementById('applications-heading-container'), document.getElementById('application-table-container-section')];
...
ApplicationTable.prototype._showContrastApplications = function (storedApps) {
  ...
  (0, _util.setElementDisplay)(vulnsHeader.lastElementChild, "none");
  ...
  (0, _util.getOrgApplications)().then(function (json) {
    ...
    _this3.createTableRows(applications, storedApps);
  }).catch(function () {
...
ApplicationTable.prototype.createTableRows = function (applications, storedApps) {
  ...
  applications.forEach(function (app) {
    return _this4.createAppTableRow(app, storedApps);
  });
};
