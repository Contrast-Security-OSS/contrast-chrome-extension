...
TableRow.prototype._handleConnectError = function (error) {
  var errorElement = document.getElementById('error-message-footer');
  (0, _util.setElementDisplay)(errorElement, "block");
  (0, _util.setElementText)(errorElement, "" + error.toString());
  setTimeout(function () {
    return (0, _util.setElementDisplay)(errorElement, "none");
  }, 10000);
