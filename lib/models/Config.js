...
Config.prototype._renderConfigButton = function (configButton) {
  ...
  configButton.addEventListener('click', function () {
    ...
    chrome.tabs.sendMessage(_this.tab.id, { url: _this.tab.url, action: _util.CONTRAST_INITIALIZE }, function (response) {
      ...
      if (response.action === _util.CONTRAST_INITIALIZED) {
        ...
        _this.setCredentialsInSettings(response.contrastObj);
...
Config.prototype.setGearIcon = function () {
  ...
  var configureGearIcon = document.getElementsByClassName('configure-gear')[0];
