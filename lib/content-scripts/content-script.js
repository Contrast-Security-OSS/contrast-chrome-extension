...
function _initializeContrast(request, sendResponse) {
  ...
  chrome.storage.local.set((_chrome$storage$local = {}, (0, _defineProperty3.default)(_chrome$storage$local, CONTRAST_USERNAME, profileEmail.trim()), (0, _defineProperty3.default)(_chrome$storage$local, CONTRAST_SERVICE_KEY, serviceKey.trim()), (0, _defineProperty3.default)(_chrome$storage$local, CONTRAST_API_KEY, apiKey.trim()), (0, _defineProperty3.default)(_chrome$storage$local, CONTRAST_ORG_UUID, orgUuid.trim()), (0, _defineProperty3.default)(_chrome$storage$local, TEAMSERVER_URL, teamServerUrl), _chrome$storage$local), function () {
