...
var CONTRAST_INITIALIZE = "contrast__initialize_user";
var CONTRAST_INITIALIZED = "contrast__user_initialized";
...
var UUID_V4_REGEX = new RegExp(/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
