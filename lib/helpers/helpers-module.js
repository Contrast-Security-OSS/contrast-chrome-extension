...
var Helpers = exports.Helpers = function (chrome) {
  var _SEVERITY;
  ...
  var SEVERITY = (_SEVERITY = {}, _defineProperty(_SEVERITY, SEVERITY_NOTE, 0), _defineProperty(_SEVERITY, SEVERITY_LOW, 1), _defineProperty(_SEVERITY, SEVERITY_MEDIUM, 2), _defineProperty(_SEVERITY, SEVERITY_HIGH, 3), _defineProperty(_SEVERITY, SEVERITY_CRITICAL, 4), _SEVERITY);
  ...
  var STORED_TAB_PREFIX = "contrast__tab";
  var GATHER_SCRIPTS = "contrast__gatherScripts";
  var STORED_TRACES_KEY = "contrast__traces";
  var TRACES_REQUEST = "contrast__getStoredTraces";
  var STORED_APPS_KEY = "contrast__APPS";
  var CONTRAST__STORED_APP_LIBS = "CONTRAST__STORED_APP_LIBS";
  ...
  */
  ...
  function _readLibraryVulnerabilities() {
    return fetch("../data/jsrepository.json").then(function (response) {
      return response.json();
    }).catch(new Error("Error getting js lib vulnerabilities"));
  }

  function analyzeLibraries(tab) {
    return _readLibraryVulnerabilities().then(function (json) {
      var libraries = Object.keys(json);
    }).catch(new Error("Error analyzing libraries"));
  }

  return {
    fetchTeamserver: fetchTeamserver,
    getAuthorizationHeader: getAuthorizationHeader,
    getOrganizationVulnerabilitiesIdsUrl: getOrganizationVulnerabilitiesIdsUrl,
    getVulnerabilityShortUrl: getVulnerabilityShortUrl,
    getApplicationsUrl: getApplicationsUrl,
    getVulnerabilityTeamserverUrl: getVulnerabilityTeamserverUrl,
    getStoredCredentials: getStoredCredentials,
    getOrganizationVulnerabilityIds: getOrganizationVulnerabilityIds,
    getVulnerabilityShort: getVulnerabilityShort,
    getApplications: getApplications,
    isCredentialed: isCredentialed,
    deDupeArray: deDupeArray,
    getHostFromUrl: getHostFromUrl,
    isBlacklisted: isBlacklisted,
    isContrastTeamserver: isContrastTeamserver,
    updateTabBadge: updateTabBadge,
    removeLoadingBadge: removeLoadingBadge,
    retrieveApplicationFromStorage: retrieveApplicationFromStorage,
    generateURLString: generateURLString,
    processTeamserverUrl: processTeamserverUrl,
    ...
    SEVERITY: SEVERITY,
    SEVERITY_NOTE_ICON_PATH: SEVERITY_NOTE_ICON_PATH,
    SEVERITY_LOW_ICON_PATH: SEVERITY_LOW_ICON_PATH,
    SEVERITY_MEDIUM_ICON_PATH: SEVERITY_MEDIUM_ICON_PATH,
    SEVERITY_HIGH_ICON_PATH: SEVERITY_HIGH_ICON_PATH,
    SEVERITY_CRITICAL_ICON_PATH: SEVERITY_CRITICAL_ICON_PATH,
    TEAMSERVER_INDEX_PATH_SUFFIX: TEAMSERVER_INDEX_PATH_SUFFIX,
    TEAMSERVER_ACCOUNT_PATH_SUFFIX: TEAMSERVER_ACCOUNT_PATH_SUFFIX,
    TEAMSERVER_PROFILE_PATH_SUFFIX: TEAMSERVER_PROFILE_PATH_SUFFIX,
    TEAMSERVER_API_PATH_SUFFIX: TEAMSERVER_API_PATH_SUFFIX,
    VALID_TEAMSERVER_HOSTNAMES: VALID_TEAMSERVER_HOSTNAMES,
    CONTRAST_GREEN: CONTRAST_GREEN,
    CONTRAST_RED: CONTRAST_RED,
    CONTRAST_YELLOW: CONTRAST_YELLOW,
    CONTRAST_CONFIGURE_TEXT: CONTRAST_CONFIGURE_TEXT,
    LISTENING_ON_DOMAIN: LISTENING_ON_DOMAIN,
    GATHER_FORMS_ACTION: GATHER_FORMS_ACTION,
    GATHER_SCRIPTS: GATHER_SCRIPTS,
    STORED_TRACES_KEY: STORED_TRACES_KEY,
    TRACES_REQUEST: TRACES_REQUEST,
    STORED_APPS_KEY: STORED_APPS_KEY,
    STORED_TAB_PREFIX: STORED_TAB_PREFIX,
    CONTRAST__STORED_APP_LIBS: CONTRAST__STORED_APP_LIBS
  };
}(chrome);