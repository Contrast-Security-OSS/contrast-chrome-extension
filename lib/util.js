 ...
 */
var UUID_V4_REGEX = new RegExp(/[\/][A-F\d]{8}-[A-F\d]{4}-4[A-F\d]{3}-[89AB][A-F\d]{3}-[A-F\d]{12}$/i // eslint-disable-line no-useless-escape
);
