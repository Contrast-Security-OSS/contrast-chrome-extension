...
exports.updateExtensionIcon = exports.murmur = exports.isEmptyObject = exports.isHTTP = exports.loadingBadge = exports.hideElementAfterTimeout = exports.changeElementVisibility = exports.setElementText = exports.setElementDisplay = exports.processTeamserverUrl = exports.hasIDorUUID = exports.generateTraceURLString = exports.removeLoadingBadge = exports.updateTabBadge = exports.isContrastTeamserver = exports.isBlacklisted = exports.getHostFromUrl = exports.deDupeArray = exports.isCredentialed = exports.getOrgApplications = exports.getVulnerabilityShort = exports.getOrganizationVulnerabilityIds = exports.getStoredCredentials = exports.getVulnerabilityTeamserverUrl = exports.getApplicationsUrl = exports.getVulnerabilityShortUrl = exports.getOrganizationVulnerabilitiesIdsUrl = exports.getAuthorizationHeader = exports.fetchTeamserver = exports.UUID_V4_REGEX = exports.capitalize = exports.CONTRAST_WAPPALIZE = exports.CONTRAST__STORED_APP_LIBS = exports.CONTRAST_INITIALIZED = exports.CONTRAST_INITIALIZE = exports.CONNECTED_APP_DOMAINS = exports.APPLICATION_DISCONNECTED = exports.APPLICATION_CONNECTED = exports.HIGHLIGHT_VULNERABLE_FORMS = exports.LOADING_DONE = exports.STORED_APPS_KEY = exports.TRACES_REQUEST = exports.STORED_TRACES_KEY = exports.GATHER_SCRIPTS = exports.GATHER_FORMS_ACTION = exports.LISTENING_ON_DOMAIN = exports.CONTRAST_CONFIGURE_TEXT = exports.CONTRAST_YELLOW = exports.CONTRAST_RED = exports.CONTRAST_GREEN = exports.VALID_TEAMSERVER_HOSTNAMES = exports.TEAMSERVER_API_PATH_SUFFIX = exports.TEAMSERVER_PROFILE_PATH_SUFFIX = exports.TEAMSERVER_ACCOUNT_PATH_SUFFIX = exports.TEAMSERVER_INDEX_PATH_SUFFIX = exports.TEAMSERVER_BASE = exports.SEVERITY_TEXT_COLORS = exports.SEVERITY_BACKGROUND_COLORS = exports.SEVERITY = exports.SEVERITY_CRITICAL = exports.SEVERITY_HIGH = exports.SEVERITY_MEDIUM = exports.SEVERITY_LOW = exports.SEVERITY_NOTE = exports.TEAMSERVER_URL = exports.CONTRAST_ORG_UUID = exports.CONTRAST_API_KEY = exports.CONTRAST_SERVICE_KEY = exports.CONTRAST_USERNAME = undefined;
...
var _SEVERITY, _SEVERITY_BACKGROUND_, _SEVERITY_TEXT_COLORS;
...
var SEVERITY = exports.SEVERITY = (_SEVERITY = {}, (0, _defineProperty3.default)(_SEVERITY, SEVERITY_NOTE, 0), (0, _defineProperty3.default)(_SEVERITY, SEVERITY_LOW, 1), (0, _defineProperty3.default)(_SEVERITY, SEVERITY_MEDIUM, 2), (0, _defineProperty3.default)(_SEVERITY, SEVERITY_HIGH, 3), (0, _defineProperty3.default)(_SEVERITY, SEVERITY_CRITICAL, 4), _SEVERITY);

var SEVERITY_BACKGROUND_COLORS = exports.SEVERITY_BACKGROUND_COLORS = (_SEVERITY_BACKGROUND_ = {}, (0, _defineProperty3.default)(_SEVERITY_BACKGROUND_, SEVERITY_NOTE, "rgb(238, 238, 238)"), (0, _defineProperty3.default)(_SEVERITY_BACKGROUND_, SEVERITY_LOW, "rgb(220, 220, 220)"), (0, _defineProperty3.default)(_SEVERITY_BACKGROUND_, SEVERITY_MEDIUM, "rgb(247, 182, 0)"), (0, _defineProperty3.default)(_SEVERITY_BACKGROUND_, SEVERITY_HIGH, "rgb(247, 138, 49)"), (0, _defineProperty3.default)(_SEVERITY_BACKGROUND_, SEVERITY_CRITICAL, "rgb(230, 48, 37)"), _SEVERITY_BACKGROUND_);

var SEVERITY_TEXT_COLORS = exports.SEVERITY_TEXT_COLORS = (_SEVERITY_TEXT_COLORS = {}, (0, _defineProperty3.default)(_SEVERITY_TEXT_COLORS, SEVERITY_NOTE, "rgb(102, 102, 102)"), (0, _defineProperty3.default)(_SEVERITY_TEXT_COLORS, SEVERITY_LOW, "rgb(41, 41, 41)"), (0, _defineProperty3.default)(_SEVERITY_TEXT_COLORS, SEVERITY_MEDIUM, "white"), (0, _defineProperty3.default)(_SEVERITY_TEXT_COLORS, SEVERITY_HIGH, "white"), (0, _defineProperty3.default)(_SEVERITY_TEXT_COLORS, SEVERITY_CRITICAL, "white"), _SEVERITY_TEXT_COLORS);

var TEAMSERVER_BASE = exports.TEAMSERVER_BASE = "/Contrast/static/ng";
...
var VALID_TEAMSERVER_HOSTNAMES = exports.VALID_TEAMSERVER_HOSTNAMES = ["app.contrastsecurity.com", "apptwo.contrastsecurity.com", "eval.contratsecurity.com", "alpha.contrastsecurity.com", "localhost", "teamserver-darpa.contsec.com"];
...
var GATHER_SCRIPTS = exports.GATHER_SCRIPTS = "contrast__gather_scripts";
...
var LOADING_DONE = exports.LOADING_DONE = "contrast__LOADING_DONE_requests";
var HIGHLIGHT_VULNERABLE_FORMS = exports.HIGHLIGHT_VULNERABLE_FORMS = "contrast__highlight_vuln_forms";
var APPLICATION_CONNECTED = exports.APPLICATION_CONNECTED = "contrast__application__connected";
var APPLICATION_DISCONNECTED = exports.APPLICATION_DISCONNECTED = "contrast__application__disconnected";
var CONNECTED_APP_DOMAINS = exports.CONNECTED_APP_DOMAINS = "contrast__connected_app_domains";
var CONTRAST_INITIALIZE = exports.CONTRAST_INITIALIZE = "contrast__initialize_user";
var CONTRAST_INITIALIZED = exports.CONTRAST_INITIALIZED = "contrast__user_initialized";
var CONTRAST__STORED_APP_LIBS = exports.CONTRAST__STORED_APP_LIBS = "contrast__stored_libraries";
var CONTRAST_WAPPALIZE = exports.CONTRAST_WAPPALIZE = "contrast__wappalzye";
// export const WAPPALYZER_SERVICE = "http://localhost:5203";

// don't look for vulnerabilities on these domains
var BLACKLISTED_DOMAINS = ["chrome://", "file://", "/Contrast/api/ng/", "/Contrast/s/", "/Contrast/static/ng", "google.com", "ajax.googleapis.com", "gstatic.net", "cloudfront.com", "developer.chrome", "facebook.com", "atlassian.net", "cloudfront.net", "cloudfront.com", "cdn.sstatic.net", "reddit.com", "sockjs-node/info", "socket.io"];
...
function fetchTeamserver(url, params, authHeader, apiKey) {
  ...
  var requestUrl = method === "GET" ? url + params : url;
  var fetchOptions = {
    method: method,
    headers: new Headers({
  ...
  if (method !== "GET") {
    fetchOptions.body = (0, _stringify2.default)(params);
...
function getVulnerabilityShort(traceUuid, appID) {
  return getStoredCredentials().then(function (items) {
    var url = getVulnerabilityShortUrl(items[TEAMSERVER_URL], items[CONTRAST_ORG_UUID], traceUuid, appID);
    var authHeader = getAuthorizationHeader(items[CONTRAST_USERNAME], items[CONTRAST_SERVICE_KEY]);
...
function updateExtensionIcon(tab) {
  var image = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0;
...
function generateTraceURLString(tracePaths) {
  ...
  var matchRoutePathParams = false;
  var paths = tracePaths.map(function (path) {
 ...
 */
var UUID_V4_REGEX = exports.UUID_V4_REGEX = new RegExp(/^[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}$/i);
var PATH_ID_REGEX = new RegExp(/\/(\d+)/);
...
function setElementText(element, text) {
  if (!element) {
    ...
    throw new Error("Text must be a string, received " + (typeof text === "undefined" ? "undefined" : (0, _typeof3.default)(text)));
  }
  try {
 ...
 * @return {void}
 */
function hideElementAfterTimeout(element) {
...
exports.hasIDorUUID = hasIDorUUID;
