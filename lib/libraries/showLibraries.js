...
var renderVulnerableLibraries = function () {
  var _ref2 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee2(tab, application) {
    var tabAndApp, libraries, container, ul, i, len, lib, j, versions, keys, vals, version, k, kLen;
          ...
          case 11:
            ...
            for (i = 0, len = libraries.length; i < len; i++) {
              ...
              if (lib.vulnerabilitiesCount > 1) {
                for (j = 0; j < lib.vulnerabilitiesCount; j++) {
                  versions = lib.vulnerabilities[j].versions;
                  keys = (0, _keys2.default)(versions);
                  vals = (0, _values2.default)(versions);
                  version = [];
