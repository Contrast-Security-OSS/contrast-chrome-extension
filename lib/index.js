          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 3:
                ...
                } else if (credentialed && config._isContrastPage() || !config.hasApp) {
...
function configureTabs() {
  var klass = "config-tab";
  var configTabs = document.getElementsByClassName(klass);
...
function renderCredentials() {
  var table = document.getElementById("application-table-container-section");
  var creds = document.getElementById("configuration-section");

  (0, _util.setElementDisplay)(table, "none");
  (0, _util.setElementDisplay)(creds, "flex");
}

function renderApplications() {
  var tableContainer = document.getElementById("application-table-container-section");
  var creds = document.getElementById("configuration-section");

  (0, _util.setElementDisplay)(tableContainer, "flex");
  (0, _util.setElementDisplay)(creds, "none");
