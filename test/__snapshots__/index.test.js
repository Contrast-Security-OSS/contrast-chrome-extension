...
<body>
  <header class="headers-section section">
    <div id="configuration-header" class="flex-row header-row flex-row-head">
      <img src="/img/icon.png" alt="" class="logo-icon flex-row-item">
      <div id="config-header-text" class="flex-row-item">
        <h5>
    ...
    <div id="vulnerabilities-header" class="flex-row header-row">
      <img src="/img/icon.png" alt="" class="logo-icon flex-row-item">
      <div id="vulns-header-text-container" class="flex-row-item">
        <h5>
          <strong>Contrast</strong>
        </h5>
  ...
  <section id="vulnerabilities-section" class="panel panel-default section">
    ...
    <div id="vulnerabilities-found-on-page" class="panel-body">
      <div class="app-vulnerabilities-div">
        <img id="vulns-loading" src="/img/ring-alt.gif" alt="loading">
  ...
  <section id="application-table-container-section" class="section">
    <p id="connected-domain-message" class="hidden"></p>
    <div id="table-container">
      <table class="table table-responsive" id="application-table">
        <tbody id="application-table-body">
    ...
    <div class="container color-gray panel-body" id="configure-extension">
      <form>
        <div class="form-group">
          ...
          <input placeholder="https://<domain>.contrastsecurity.com" class="form-control user-inputs" type="text" name="" value="" id="contrast-url-input">
        </div>
        <div class="form-group">
          <input id="contrast-api-key-input" placeholder="API Key" class="form-control user-inputs" type="text" name="" value="">
          <input id="contrast-service-key-input" placeholder="Service Key" class="form-control user-inputs" type="text" name="" value="">
          <input id="contrast-username-input" placeholder="Username" class="form-control user-inputs" type="text" name="" value="">
          <input id="contrast-org-uuid-input" placeholder="Organization UUID" class="form-control user-inputs" type="text" name="" value="">
  ...
  <footer class="footers-section section">
    ...
    <div id="configured-footer" class="flex-row footer-row flex-row-foot">
      ...
      <div id="icon-container">
        <div id="gear-container" class="icon-container">
          <svg id="configure-gear" fill="#666" height="22px" width="22px" class="configure-gear" viewBox="0 0 850 1050">
            <path d="M585.143 521.143q0-60.571-42.857-103.429t-103.429-42.857-103.429 42.857-42.857 103.429 42.857 103.429 103.429 42.857 103.429-42.857 42.857-103.429zm292.571-62.286v126.857q0 6.857-4.571 13.143t-11.429 7.429l-105.714 16q-10.857 30.857-22.286 52 20 28.571 61.143 78.857 5.714 6.857 5.714 14.286t-5.143 13.143q-15.429 21.143-56.571 61.714t-53.714 40.571q-6.857 0-14.857-5.143L591.429 816q-25.143 13.143-52 21.714-9.143 77.714-16.571 106.286-4 16-20.571 16H375.43q-8 0-14-4.857t-6.571-12.286l-16-105.143q-28-9.143-51.429-21.143l-80.571 61.143q-5.714 5.143-14.286 5.143-8 0-14.286-6.286-72-65.143-94.286-96-4-5.714-4-13.143 0-6.8574.571-13.143 8.571-12 29.143-38t30.857-40.286q-15.429-28.571-23.429-56.571L16.572 603.999q-7.429-1.143-12-7.143T.001 583.427V456.57q0-6.857 4.571-13.143t10.857-7.429l106.286-16q8-26.286 22.286-52.571-22.857-32.571-61.143-78.857-5.714-6.857-5.714-13.714 0-5.714 5.143-13.143 14.857-20.571 56.286-61.429t54-40.857q7.429 0 14.857 5.714l78.857 61.143q25.143-13.143 52-21.714 9.143-77.714 16.571-106.286 4-16 20.571-16h126.857q8 0 14 4.857t6.571 12.286l16 105.143q28 9.143 51.429 21.143l81.143-61.143q5.143-5.143 13.714-5.143 7.429 0 14.286 5.714 73.714 68 94.286 97.143 4 4.571 4 12.571 0 6.857-4.571 13.143-8.571 12-29.143 38t-30.857 40.286q14.857 28.571 23.429 56l104.571 16q7.429 1.143 12 7.143t4.571 13.429z"></path>
          </svg>
        </div>
        <div id="app-icon-container" class="icon-container">
          <svg id="app-icon" fill="#666" height="22px" width="22px" class="configure-gear" viewBox="0 0 1100 1000">
            <g>
              <path d="M1024 576V100.571q0-7.429-5.429-12.857t-12.857-5.429H91.428q-7.429 0-12.857 5.429t-5.429 12.857V576q0 7.429 5.429 12.857t12.857 5.429h914.286q7.429 0 12.857-5.429T1024 576zm73.143-475.428v621.714q0 37.714-26.857 64.571t-64.571 26.857H694.858q0 21.143 9.143 44.286t18.286 40.571 9.143 24.857q0 14.857-10.857 25.714t-25.714 10.857H402.288q-14.857 0-25.714-10.857t-10.857-25.714q0-8 9.143-25.143t18.286-40 9.143-44.571H91.432q-37.714 0-64.571-26.857T.004 722.286V100.572q0-37.714 26.857-64.571T91.432 9.144h914.286q37.714 0 64.571 26.857t26.857 64.571z">
              </path>
            </g>
          </svg>
        </div>
